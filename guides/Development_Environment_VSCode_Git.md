...
## 5.4 Working with Classroom 50

Your assignments will be submitted through the GitHub repository generated by Classroom 50. The standard workflow for each assignment is:

1. Open the invitation link provided by your instructor. Sign in to your GitHub account if you are not already signed in.

2. Accept the assignment. Classroom 50 will automatically create a personal repository for you. Click the repository link to open it.

3. In your assignment repository, click the green <> Code button and copy the repository’s HTTPS URL.

4. Clone the repository to your local computer. In VS Code, open the Command Palette (Ctrl+Shift+P), type or select Git: Clone, and paste the URL. Select a local folder in which to save it.

5. Work on the assignment inside the cloned folder. Follow the standard Git workflow: Pull → Stage → Commit → Push.

6. Push your work to GitHub regularly. Your instructor will be able to see your latest pushed commits. 
