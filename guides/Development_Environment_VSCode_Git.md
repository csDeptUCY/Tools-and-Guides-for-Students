...
![Installing the Remote SSH extension](media/image1.png)
...
![Adding a new remote SSH connection](media/image2.png)
...
![Selecting the remote SSH connection](media/image3.png)

When you are asked to choose the operating system of the remote host, select Linux and then enter.

![Selecting Linux as the remote operating system](media/image4.png)
...
![Confirming the remote host public key fingerprint](media/image5.png)

Next, you will be asked to provide your password (given by the university)

![Entering the remote account password](media/image6.png)
...
![Active VS Code Remote SSH connection](media/image7.png)
...
![Opening a folder on the remote host](media/image8.png)
